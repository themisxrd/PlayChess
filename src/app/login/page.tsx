    ...
    return (
        <div className="flex items-center justify-center w-full h-screen">
            <div className="w-[300px] p-2 flex flex-col gap-2  text-center ">
                ...
                <p className="text-black/50 text-[0.7rem]">Play Chess / Login</p>
                ...
                <div className="flex gap-2 items-center">
                    <CustomCheckbox onChange={handleCheckboxChange} text="Remember Me" />
          ...
          hover:bg-blue-600 overflow-hidden"
                ...
                <p className="text-[0.8rem]">Don't you have an account? <a className="text-blue-600 cursor-pointer" href="/register">Register</a> now!</p>
